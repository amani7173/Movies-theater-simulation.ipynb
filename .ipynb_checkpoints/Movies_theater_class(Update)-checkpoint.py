...
class Movies_theater:
    ...
    def revenue(self , seats=30, screens =5 , simulations = 1000):
    ...
    def max_day(self):
        ...
        for i in week_days:
            if ( i == max_d):
                count = count+1
        return (f"{days[count]} is the highest revenue day in the week with a total of {max_d} SAR.") # the day hase the highest summed revenue is Tuseday 
